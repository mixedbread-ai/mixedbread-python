...
- <code title="get /">client.<a href="./src/mixedbread/_client.py">status</a>() -> <a href="./src/mixedbread/types/status_response.py">StatusResponse</a></code>
...
```python
from mixedbread.types.vector_stores import VectorStoreFile, VectorStoreFileDeleted, FileListResponse
```
...
- <code title="get /v1/jobs/{job_id}">client.jobs.<a href="./src/mixedbread/resources/jobs.py">retrieve</a>(job_id) -> JobStatus</code>
