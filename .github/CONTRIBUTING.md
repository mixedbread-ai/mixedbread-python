...
This repository holds the source of `mixedbread on PyPI`. The code is generated from Mixedbread's OpenAPI
...
- **Hand-written helpers** (under `src/mixedbread/lib/`): also welcome as an issue or a PR that we use as a
