...
class TestParse:
    ...
    def test_method_create(self, client: Mixedbread) -> None:
        parse = client.document_intelligence.parse.create(
    ...
    def test_method_retrieve(self, client: Mixedbread) -> None:
        parse = client.document_intelligence.parse.retrieve(
            "job_id",
        )
        assert_matches_type(ParseResponse, parse, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: Mixedbread) -> None:
        response = client.document_intelligence.parse.with_raw_response.retrieve(
            "job_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Mixedbread) -> None:
        with client.document_intelligence.parse.with_streaming_response.retrieve(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Mixedbread) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.document_intelligence.parse.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncParse:
    ...
    async def test_method_create(self, async_client: AsyncMixedbread) -> None:
        parse = await async_client.document_intelligence.parse.create(
            file=b"raw file contents",
        )
        assert_matches_type(ParseResponse, parse, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncMixedbread) -> None:
        response = await async_client.document_intelligence.parse.with_raw_response.create(
            file=b"raw file contents",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncMixedbread) -> None:
        async with async_client.document_intelligence.parse.with_streaming_response.create(
            file=b"raw file contents",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncMixedbread) -> None:
        parse = await async_client.document_intelligence.parse.retrieve(
            "job_id",
        )
        assert_matches_type(ParseResponse, parse, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncMixedbread) -> None:
        response = await async_client.document_intelligence.parse.with_raw_response.retrieve(
            "job_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncMixedbread) -> None:
        async with async_client.document_intelligence.parse.with_streaming_response.retrieve(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncMixedbread) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.document_intelligence.parse.with_raw_response.retrieve(
                "",
            )
