...
class TestMixedbread:
    ...
    def test_omit_retry_count_header(
        ...
        response = client.with_raw_response.base_status_check(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.with_raw_response.base_status_check(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncMixedbread:
    ...
    async def test_retries_taken(
        ...
        response = await client.with_raw_response.base_status_check()
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.with_raw_response.base_status_check(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.with_raw_response.base_status_check(extra_headers={"x-stainless-retry-count": "42"})
